...
import { Phone, MessageCircle, Mail, Search, ChevronDown, ChevronLeft, ChevronRight, Inbox, Loader2, Plus, Download, UserPlus } from "lucide-react";
import { api, formatApiErrorDetail, STATUSES, TYPE_LABELS, SOLUTION_LABELS, typeLabel, fmtDate, trPhoneLink, selectCls, ILLER } from "./adminApi";
import { BRANCH_OPTIONS } from "@/data/site";
...
// --- Talep listesi (KPI + filtre + tablo + sayfalama) ---
export const LeadsManager = ({ onLogout }) => {
